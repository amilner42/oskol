...
/// Creates a simple card without enhancements. Ids are chosen by the caller
/// so that games stay deterministic.
pub fn new(id: String, rank: Rank, suit: Suit) -> Card {
...
pub fn with_enhancement(
  ...
  Card(id: id, rank: rank, suit: suit, enhancement: Some(enh))
}

/// Short stable code for a rank and suit, e.g. "AS" or "10H". Used as the id
/// of the cards in a fresh deck.
pub fn code(rank: Rank, suit: Suit) -> String {
  let r = case rank {
    Two -> "2"
    Three -> "3"
    Four -> "4"
