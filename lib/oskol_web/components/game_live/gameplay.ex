defmodule OskolWeb.Components.GameLive.Gameplay do
  ...
  def game_screen(assigns) do
    ...
    <div class="flex flex-col h-screen-safe bg-base-300 overflow-hidden">
      ...
      <div class="shrink-0 flex flex-col justify-end pt-2 px-1 pb-1 sm:pt-2 sm:px-3 sm:pb-1 bg-base-200/40">
        <.opponent_cards
    ...
    <!-- Bottom - Player Cards: shrink on mobile, minimal padding on desktop -->
      <div class="shrink-0 flex flex-col justify-start pt-1 px-1 pb-0 sm:pt-1 sm:px-3 sm:pb-0 bg-base-200/40">
        <.player_cards
          player_state={@player_state}
