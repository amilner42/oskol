...
# Signing in is on locally, and the mail lands in the local mailbox:
...
# NOTE: This is commented out by default to avoid spamming the dev env in sentry.
#
...
#   root_source_code_paths: [File.cwd!()]s
